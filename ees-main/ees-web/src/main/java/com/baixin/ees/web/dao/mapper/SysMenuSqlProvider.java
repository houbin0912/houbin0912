...
import com.baixin.ees.web.dao.model.SysMenuExample.Criterion;
...
public class SysMenuSqlProvider {
    ...
    public String insertSelective(SysMenu record) {
        ...
        if (record.getParentMenuId() != null) {
            VALUES("PARENT_MENU_ID", "#{parentMenuId,jdbcType=INTEGER}");
        }
        ...
        if (record.getUrlType() != null) {
            VALUES("URL_TYPE", "#{urlType,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getParentMenuId() != null) {
            SET("PARENT_MENU_ID = #{record.parentMenuId,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(SysMenu record) {
        ...
        if (record.getUrlType() != null) {
            SET("URL_TYPE = #{urlType,jdbcType=VARCHAR}");
        }
