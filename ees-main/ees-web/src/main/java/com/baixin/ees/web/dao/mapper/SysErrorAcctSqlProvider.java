...
import com.baixin.ees.web.dao.model.SysErrorAcctExample.Criterion;
import com.baixin.ees.web.dao.model.SysErrorAcctExample;
import java.util.List;
import java.util.Map;

public class SysErrorAcctSqlProvider {

    public String countByExample(SysErrorAcctExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("acct_error");
    ...
    public String deleteByExample(SysErrorAcctExample example) {
        BEGIN();
    ...
    public String insertSelective(SysErrorAcct record) {
        BEGIN();
        INSERT_INTO("acct_error");
        
        if (record.getAcctErrId() != null) {
            VALUES("ACCT_ERR_ID", "#{acctErrId,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(SysErrorAcctExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SysErrorAcct record = (SysErrorAcct) parameter.get("record");
        SysErrorAcctExample example = (SysErrorAcctExample) parameter.get("example");
        
        BEGIN();
        UPDATE("acct_error");
        
        if (record.getAcctErrId() != null) {
            SET("ACCT_ERR_ID = #{record.acctErrId,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(SysErrorAcct record) {
        BEGIN();
        UPDATE("acct_error");
    ...
    protected void applyWhere(SysErrorAcctExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
